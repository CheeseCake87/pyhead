...
class ScriptTag:
    ...
    def __init__(
        ...
        self._type = f'type="{self.type}" ' if self.type is not None else ""
        self._async = f'async="{self.async_}" ' if self.async_ else ""
        self._defer = f'defer="{self.defer}" ' if self.defer else ""
        self._crossorigin = (
        ...
        self._nomodule = f'nomodule="{self.nomodule}" ' if self.nomodule else ""
